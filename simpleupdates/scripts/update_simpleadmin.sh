...
echo -e "\e[1;31m2) Installing simpleadmin from the $GITTREE branch\e[0m"
			...
			wget $GITROOT/simpleadmin/www/js/band_map.js
    		...
    		wget $GITROOT/simpleadmin/www/css/bootstrap.min.css
      		...
      		wget $GITROOT/simpleadmin/www/css/Poppins.css
			wget $GITROOT/simpleadmin/www/css/all.min.css
      		sleep 1
      		cd $SIMPLE_ADMIN_DIR/www/fonts
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-300.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-300-latin.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-400-latin.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-400-latin-ext.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-500-latin.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-500-latin-ext.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-600-latin.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-600-latin-ext.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-700-latin.woff2
      		wget $GITROOT/simpleadmin/www/fonts/poppins-v21-700-latin-ext.woff2
			sleep 1
